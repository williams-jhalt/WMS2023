...
use DateTime;
use App\Model\Dsco\Discount;
use App\Model\Dsco\ExtendedAttribute;
use App\Model\Dsco\Order;
use App\Model\Dsco\OrderLine;
use App\Model\Dsco\ShipmentInfo;
use App\Model\Dsco\Tax;
use SplFileObject;
...
class CsvOrderAdapter {
    ...
    public function read(SplFileObject $file) {
        ...
        while (!$file->eof()) {
            ...
            $order->getIdentifier()->setDscoKey($row[$mapping['Id']]);
