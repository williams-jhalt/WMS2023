...
use Exception;
use App\Adapter\Dsco\CsvInventoryAdapter;
use App\Adapter\Dsco\CsvInvoiceAdapter;
...
class DscoService {
    ...
    public function __construct(string $ftpHost, string $ftpUser, string $ftpPass, DscoHandlerInterface $handler, EntityManagerInterface $em) {
